...
- [ ] Task: Create new directory `apps/quad_launchpad_mk3_demo` and copy shared assets (e.g., `lib/`).
- [ ] Task: Create basic `index.html` with a 2x2 layout container for 4 virtual grids.
