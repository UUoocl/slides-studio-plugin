...
- **Organization & Documentation**:
    - Move `manage_source_settings.html` to its own directory: `apps/obs_source_manager/`.
    - Create a `README.md` for `obs_source_manager` with description, usage, and developer overview.
    - Update `apps/space_type_generator/readme.md` to reflect the new render/settings split architecture.
    - Add the new "Manage OBS Source Settings" app to the project's app gallery page.
