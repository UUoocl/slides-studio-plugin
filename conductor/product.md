...
- **Standalone Production Apps**: A growing suite of HTML-based tools (located in `apps/`) for specialized hardware monitoring, rule management, and real-time controller demonstrations.
