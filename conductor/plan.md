...
- [ ] Task: Create the directory structure for the new app at `apps/uvc_ptz_monitor/`.
- [ ] Task: Create the base `index.html` file with the necessary HTML5 boilerplate.
- [ ] Task: Create `styles.css` and define the "Standard Slides Studio" theme (dark mode, technical aesthetic).
- [ ] Task: Create a placeholder `app.js` to ensure script loading.
