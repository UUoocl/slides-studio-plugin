!function(e, t) {
    ...
    function y(e, t, r, n) {
        ...
        for (a = 0; a < n; ++a)
            e.table[t[r + a]]++;
        for (a = o = e.table[0] = 0; a < 16; ++a)
            m[a] = o,
            o += e.table[a];
        for (a = 0; a < n; ++a)
            t[r + a] && (e.trans[m[t[r + a]]++] = a)
    }
    function b(e) {
    ...
    function x(e, t) {
        for (; e.bitcount < 24; )
            e.tag |= e.source[e.sourceIndex++] << e.bitcount,
            e.bitcount += 8;
        for (var r = 0, n = 0, a = 0, o = e.tag; n = 2 * n + (1 & o),
        o >>>= 1,
        ++a,
        r += t.table[a],
        0 <= (n -= t.table[a]); )
        ...
        for (var h = 0; h <= 1; h++) {
            ...
            if (0 != d) {
                ...
                if (!(v < 0)) {
                    ...
                    0 < m && m < 1 && (0 === h && this.addX(E(u[h], l[h], p[h], c[h], m)),
                    1 === h && this.addY(E(u[h], l[h], p[h], c[h], m)));
                    var y = (-f - Math.sqrt(v)) / (2 * d);
                    0 < y && y < 1 && (0 === h && this.addX(E(u[h], l[h], p[h], c[h], y)),
                ...
                if (0 == f)
                    continue;
                var b = -g / f;
                0 < b && b < 1 && (0 === h && this.addX(E(u[h], l[h], p[h], c[h], b)),
    ...
    M.BYTE = function(e) {
        return w.argument(0 <= e && e <= 255, "Byte value should be between 0 and 255."),
        [e]
    }
    ,
    G.BYTE = F(1),
    ...
    G.LONGDATETIME = F(8),
    M.TAG = function(e) {
        return w.argument(4 === e.length, "Tag should be exactly 4 ASCII characters."),
    ...
    M.REAL = function(e) {
        ...
        for (var u = [30], l = 0, p = (a += 1 & a.length ? "f" : "ff").length; l < p; l += 2)
    ...
    M.OPERAND = function(e, t) {
        ...
        if (Array.isArray(t))
            for (var n = 0; n < t.length; n += 1)
                w.argument(e.length === t.length, "Not enough arguments given for type" + t),
                r = r.concat(M.OPERAND(e[n], t[n]));
        else if ("SID" === t)
            r = r.concat(M.NUMBER(e));
        else if ("offset" === t)
            r = r.concat(M.NUMBER32(e));
        else if ("number" === t)
            r = r.concat(M.NUMBER(e));
        else {
            if ("real" !== t)
    ...
    function J(e, r) {
        X.call(this, "lookupListTable", Y("lookup", e, function(e) {
            ...
            return w.assert(!!t, "Unable to write GSUB lookup type " + e.lookupType + " tables."),
            new X("lookupTable",[{
                name: "lookupType",
                type: "USHORT",
                value: e.lookupType
    ...
    M.OBJECT = function(e) {
        var t = M[e.type];
        return w.argument(void 0 !== t, "No encoding function for type " + e.type),
        t(e.value)
    }
    ,
    G.OBJECT = function(e) {
        var t = G[e.type];
        return w.argument(void 0 !== t, "No sizeOf function for type " + e.type),
        t(e.value)
    }
    ,
    M.TABLE = function(e) {
    ...
    oe.prototype.parseListOfLists = function(e) {
        for (var t = this.parseOffset16List(), r = t.length, n = this.relativeOffset, a = new Array(r), o = 0; o < r; o++) {
            ...
            if (0 !== s)
                ...
                e) {
                    for (var i = this.parseOffset16List(), u = new Array(i.length), l = 0; l < i.length; l++)
    ...
    oe.prototype.parseFeatureVariationsList = function() {
        return this.parsePointer32(function() {
            var e = this.parseUShort()
              , t = this.parseUShort();
            return w.argument(1 === e && t < 1, "GPOS/GSUB feature variations table unknown."),
    ...
    var ue = {
        parse: function(e, t) {
            ...
            12 === r.format)
                ...
                !function(e, t, r, n, a) {
                    ...
                    t.skip("uShort", 3),
                    e.glyphIndexMap = {};
                    for (var s = new ie.Parser(r,n + a + 14), i = new ie.Parser(r,n + a + 16 + 2 * o), u = new ie.Parser(r,n + a + 16 + 4 * o), l = new ie.Parser(r,n + a + 16 + 6 * o), p = n + a + 16 + 8 * o, c = 0; c < o - 1; c += 1)
                        for (var h = void 0, f = s.parseUShort(), d = i.parseUShort(), g = u.parseShort(), v = l.parseUShort(), m = d; m <= f; m += 1)
                            0 !== v ? (p = l.offset + l.relativeOffset - 2,
                            p += v,
                            p += 2 * (m - d),
                            0 !== (h = ie.getUShort(r, p)) && (h = h + g & 65535)) : h = m + g & 65535,
                            e.glyphIndexMap[m] = h
                }(r, i, e, t, n)
            }
            return r
        ...
        make: function(e) {
            ...
            for (t = 0; t < p; t += 1) {
                ...
                r || void 0 === y.glyphIndex || (m = (m = (m = m.concat({
                    name: "cmap12Start_" + t,
                    type: "ULONG",
                    value: y.start
                })).concat({
            ...
            if (i.segCountX2 = 2 * (p - c),
            i.searchRange = 2 * Math.pow(2, Math.floor(Math.log(p - c) / Math.log(2))),
            ...
            i.cmap4Length = 14 + 2 * h.length + 2 + 2 * f.length + 2 * d.length + 2 * g.length + 2 * v.length,
            !r) {
                var b = 16 + 4 * m.length;
    ...
    function ve(e) {
        ...
        case 2:
            ...
            for (var t = 0; t < e.numberOfGlyphs; t++)
                e.glyphNameIndex[t] < he.length ? this.names[t] = he[e.glyphNameIndex[t]] : this.names[t] = e.names[e.glyphNameIndex[t] - he.length];
            break;
        case 2.5:
            this.names = new Array(e.numberOfGlyphs);
    ...
    be.prototype.getContours = function() {
        ...
        return w.argument(0 === t.length, "There are still points left in the current contour."),
        e
    }
    ,
        ...
        ttfGlyphLoader: function(r, e, n, a, o, s) {
            return function() {
                ...
                return t.path = function() {
                    n(t, a, o);
                    var e = s(r.glyphs, t);
                    return e.unitsPerEm = r.unitsPerEm,
                    e
                }
                ,
                Se(t, "xMin", "_xMin"),
    ...
    function Me(e, t, r, n) {
        for (var a, o, s = [], i = 0; i < r.length; i += 1) {
            ...
            if (0 !== p && 0 !== c) {
                var h = Ie(e, c + t, p, n);
                if (l._defaultWidthX = h.defaultWidthX,
                l._nominalWidthX = h.nominalWidthX,
                0 !== h.subrs) {
                    var f = Oe(e, c + h.subrs + t);
                    l._subrs = f.objects,
                    l._subrsBias = Ue(l._subrs)
                }
                l._privateDict = h
            }
            s.push(l)
    ...
    function Ge(v, m, e) {
        ...
        if (v.isCIDFont) {
            ...
            T = v.tables.cff.topDict._subrs,
            k = v.tables.cff.topDict._subrsBias,
            t = v.tables.cff.topDict._defaultWidthX,
            U = v.tables.cff.topDict._nominalWidthX;
        var I = t;
        function M(e, t) {
            C && O.closePath(),
            O.moveTo(e, t),
            ...
            for (var r, n, a, o, s, i, u, l, p, c, h, f, d = 0; d < t.length; ) {
                ...
                case 12:
                    ...
                    case 37:
                        ...
                        h = p + E.shift(),
                        f = c + E.shift(),
                        Math.abs(h - w) > Math.abs(f - D) ? w = h + E.shift() : D = f + E.shift(),
                        O.curveTo(y, b, S, x, u, l),
                        O.curveTo(p, c, h, f, w, D);
                        break;
                    default:
                        console.log("Glyph " + m.index + ": unknown operator 1200" + g),
                        E.length = 0
                    }
                    break;
                case 14:
                    0 < E.length && !L && (I = E.shift() + U,
                    L = !0),
                    C && (O.closePath(),
                    C = !1);
                    break;
                ...
                case 31:
                    ...
                    break;
                default:
                    g < 32 ? console.log("Glyph " + m.index + ": unknown operator " + g) : g < 247 ? E.push(g - 139) : g < 251 ? (r = t[d],
                    d += 1,
                    E.push(256 * (g - 247) + r + 108)) : g < 255 ? (r = t[d],
                    d += 1,
                    E.push(256 * -(g - 251) - r - 108)) : (r = t[d],
                    n = t[d + 1],
                    a = t[d + 2],
                    o = t[d + 3],
                    d += 4,
    ...
    function Be(e, t) {
        ...
        return 0 <= n && (r = n),
        0 <= (n = t.indexOf(e)) ? r = n + le.length : (r = le.length + t.length,
        t.push(e)),
        r
    }
    function Fe(e, t, r) {
        for (var n = {}, a = 0; a < e.length; a += 1) {
            var o = e[a]
              , s = t[o.name];
            void 0 === s || ke(s, o.value) || ("SID" === o.type && (s = Be(s, r)),
            n[o.op] = {
                name: o.name,
                type: o.type,
                value: s
    ...
    var He = {
        parse: function(r, n, a, e) {
            ...
            s.startOffset = o,
            s.endOffset = o + 4,
            s), u = Oe(r, i.endOffset, ie.bytesToString), l = Oe(r, u.endOffset), p = Oe(r, l.endOffset, ie.bytesToString), c = Oe(r, p.endOffset);
            a.gsubrs = c.objects,
            a.gsubrsBias = Ue(a.gsubrs);
            ...
            var f = h[0];
            if ((a.tables.cff.topDict = f)._privateDict && (a.defaultWidthX = f._privateDict.defaultWidthX,
            ...
            if (a.defaultWidthX = S.defaultWidthX,
            a.nominalWidthX = S.nominalWidthX,
            0 !== S.subrs) {
                var x = b + S.subrs
                  , T = Oe(r, x);
                a.subrs = T.objects,
                a.subrsBias = Ue(a.subrs)
            } else
                a.subrs = [],
                a.subrsBias = 0;
            ...
            a.nGlyphs = y.offsets.length) : (y = Oe(r, n + f.charStrings),
    ...
    var ze = {
        parse: function(e, t) {
            ...
            w.argument(1594834165 === r.magicNumber, "Font header has wrong magic number."),
    ...
    var _e = {
        ...
        parse: function(e, t) {
            ...
            for (var a = r.parseULong(), o = [], s = 0; s < a; s++) {
                for (var i = "", u = t + r.parseUShort(), l = r.parseUShort(), p = u; p < u + l; ++p)
    ...
    var st = {
        parse: function(e, t) {
            ...
            1 <= r.version && (r.ulCodePageRange1 = n.parseULong(),
            r.ulCodePageRange2 = n.parseULong()),
            2 <= r.version && (r.sxHeight = n.parseShort(),
    ...
    ,
    pt[2] = function(e) {
        return w.assert(1 === e.substFormat, "Lookup type 2 substFormat must be 1."),
        new $.Table("substitutionTable",[{
            name: "substFormat",
            type: "USHORT",
            value: 1
    ...
    ,
    pt[3] = function(e) {
        return w.assert(1 === e.substFormat, "Lookup type 3 substFormat must be 1."),
        new $.Table("substitutionTable",[{
            name: "substFormat",
            type: "USHORT",
            value: 1
    ...
    ,
    pt[4] = function(e) {
        return w.assert(1 === e.substFormat, "Lookup type 4 substFormat must be 1."),
        new $.Table("substitutionTable",[{
            name: "substFormat",
            type: "USHORT",
            value: 1
    ...
    pt[6] = function(e) {
        if (1 === e.substFormat)
            return new $.Table("chainContextTable",[{
                name: "substFormat",
                type: "USHORT",
                value: e.substFormat
            }, {
    ...
    var ct = {
        parse: function(e, t) {
            var r = new oe(e,t = t || 0)
              , n = r.parseVersion(1);
            return w.argument(1 === n || 1.1 === n, "Unsupported GSUB table version."),
            1 === n ? {
                version: n,
    ...
    function vt(e) {
        ...
        for (var n = [], a = [], o = t.sizeOf() + gt().sizeOf() * t.numTables; o % 4 != 0; )
            o += 1,
            a.push({
                name: "padding",
                type: "BYTE",
        ...
        for (var s = 0; s < e.length; s += 1) {
            ...
            o += u,
            w.argument(!isNaN(o), "Something went wrong calculating the offset."); o % 4 != 0; )
                o += 1,
                a.push({
                    name: "padding",
                    type: "BYTE",
    ...
    var yt = {
        ...
        fontToTable: function(e) {
            ...
            A && P.push(A);
            for (var N = vt(P), H = dt(N.encode()), z = N.fields, W = !1, q = 0; q < z.length; q += 1)
    ...
    function Ct(e, t, r, n, a) {
        var o;
        return o = 0 < (t & n) ? (o = e.parseByte(),
        0 == (t & a) && (o = -o),
        r + o) : 0 < (t & a) ? r : r + e.parseShort()
    }
    function wt(e, t, r) {
        ...
        0 < e.numberOfContours) {
            ...
            for (var p = 0; p < l; p += 1)
                ...
                0 < (8 & a))
                    for (var c = o.parseByte(), h = 0; h < c; h += 1)
                        n.push(a),
                        p += 1;
            if (w.argument(n.length === l, "Bad flags."),
            0 < s.length) {
                var f, d = [];
                if (0 < l) {
                    for (var g = 0; g < l; g += 1)
            ...
            for (var S = !0; S; ) {
                ...
                x.dy = o.parseShort()) : x.matchedPoints = [o.parseUShort(), o.parseUShort()] : 0 < (2 & n) ? (x.dx = o.parseChar(),
                x.dy = o.parseChar()) : x.matchedPoints = [o.parseByte(), o.parseByte()],
                0 < (8 & n) ? x.xScale = x.yScale = o.parseF2Dot14() : 0 < (64 & n) ? (x.xScale = o.parseF2Dot14(),
                x.yScale = o.parseF2Dot14()) : 0 < (128 & n) && (x.xScale = o.parseF2Dot14(),
    ...
    function It(e) {
        ...
        for (var r = function(e) {
            ...
            return w.argument(0 === r.length, "There are still points left in the current contour."),
            t
        }(e), n = 0; n < r.length; ++n) {
            var a = r[n]
              , o = null
    ...
    (kt.prototype = Tt.prototype = {
        ...
        getFeatureTable: function(e, t, r, n) {
            ...
            if (a) {
                ...
                if (n) {
                    var l = i.length;
                    return w.assert(0 === l || r >= i[l - 1].tag, "Features must be added in alphabetical order."),
                    o = {
                        tag: r,
                        feature: {
                            params: 0,
        ...
        getLookupTables: function(e, t, r, n, a) {
            var o = this.getFeatureTable(e, t, r, a)
              , s = [];
            if (o) {
                for (var i, u = o.lookupListIndexes, l = this.font.tables[this.tableName].lookups, p = 0; p < u.length; p++)
    ...
    Ut.prototype.getAlternates = function(e, t, r) {
        for (var n = [], a = this.getLookupTables(t, r, e, 3), o = 0; o < a.length; o++)
            for (var s = a[o].subtables, i = 0; i < s.length; i++)
                for (var u = s[i], l = this.expandCoverage(u.coverage), p = u.alternateSets, c = 0; c < l.length; c++)
                    n.push({
                        sub: l[c],
                        by: p[c]
                    });
    ...
    Ut.prototype.addLigature = function(e, t, r, n) {
        ...
        a.subtables[0] = o),
        w.assert(1 === o.coverage.format, "Ligature: unable to modify coverage table format " + o.coverage.format);
        var s = t.sub[0]
          , i = t.sub.slice(1)
          , u = {
            ligGlyph: t.by,
    ...
    var Yt = {
        ...
        interpolate: function(e, t, r, n) {
            ...
            if (!n || n === this)
                ...
                u = t.x - t.xo,
                l = r.x - r.xo,
                0 === (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? void (e.x = e.xo + (u + l) / 2) : void (e.x = e.xo + (u * i + l * s) / p);
            a = n.distance(e, t, !0, !0),
            o = n.distance(e, r, !0, !0),
            u = n.distance(t, t, !1, !0),
            l = n.distance(r, r, !1, !0),
            0 !== (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? Yt.setRelative(e, e, (u * i + l * s) / p, n, !0) : Yt.setRelative(e, e, (u + l) / 2, n, !0)
        },
      ...
      , jt = {
        ...
        interpolate: function(e, t, r, n) {
            ...
            if (!n || n === this)
                ...
                u = t.y - t.yo,
                l = r.y - r.yo,
                0 === (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? void (e.y = e.yo + (u + l) / 2) : void (e.y = e.yo + (u * i + l * s) / p);
            a = n.distance(e, t, !0, !0),
            o = n.distance(e, r, !0, !0),
            u = n.distance(t, t, !1, !0),
            l = n.distance(r, r, !1, !0),
            0 !== (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? jt.setRelative(e, e, (u * i + l * s) / p, n, !0) : jt.setRelative(e, e, (u + l) / 2, n, !0)
        },
        normalSlope: 0,
        setRelative: function(e, t, r, n, a) {
            if (n && n !== this) {
    ...
    Zt.prototype.interpolate = function(e, t, r, n) {
        ...
        0 !== (p = (u = Math.abs(s)) + (l = Math.abs(i))) ? this.setRelative(e, e, (a * l + o * u) / p, n, !0) : this.setRelative(e, e, (a + o) / 2, n, !0)
    }
    ,
    ...
    function or(e, t) {
        O.DEBUG && console.log(t.step, "SFVTCA[" + e.axis + "]"),
        t.fv = e
    }
    function sr(e, t) {
    ...
    function ur(e) {
        O.DEBUG && console.log(e.step, "POP[]"),
        e.stack.pop()
    }
    function lr(e, t) {
        var r = t.stack.pop()
    ...
    function cr(e, t) {
        for (var r = t.stack, n = e ? t.rp1 : t.rp2, a = (e ? t.z0 : t.z1)[n], o = t.fv, s = t.pv, i = t.loop, u = t.z2; i--; ) {
            ...
            o.touch(p),
            O.DEBUG && console.log(t.step, (1 < t.loop ? "loop " + (t.loop - i) + ": " : "") + "SHP[" + (e ? "rp1" : "rp2") + "]", l)
        }
        t.loop = 1
    }
    function hr(e, t) {
        ...
        for (var p = s.distance(a, a, !1, !0); l !== a && o.setRelative(l, l, p, s),
        (l = l.nextPointOnContour) !== u; )
            ;
    }
    function fr(e, t) {
        var r, n, a = t.stack, o = e ? t.rp1 : t.rp2, s = (e ? t.z0 : t.z1)[o], i = t.fv, u = t.pv, l = a.pop();
        switch (O.DEBUG && console.log(t.step, "SHZ[" + e + "]", l),
        l) {
        case 0:
            r = t.tZone;
            break;
    ...
    function br(e, t) {
        var r = t.stack
          , n = r.pop();
        O.DEBUG && console.log(t.step, "ROUND[]"),
    ...
    function Ur(e, t, r, n, a, o) {
        var s, i, u, l, p = o.stack, c = e && p.pop(), h = p.pop(), f = o.rp0, d = o.z0[f], g = o.z1[h], v = o.minDis, m = o.fv, y = o.dpv;
        u = 0 <= (i = s = y.distance(g, d, !0, !0)) ? 1 : -1,
        i = Math.abs(i),
        e && (l = o.cvt[c],
        n && Math.abs(i - l) < o.cvCutIn && (i = l)),
        r && i < v && (i = v),
        n && (i = o.round(i)),
        m.setRelative(g, d, u * i, y),
        m.touch(g),
        O.DEBUG && console.log(o.step, (e ? "MIRP[" : "MDRP[") + (t ? "M" : "m") + (r ? ">" : "_") + (n ? "R" : "_") + (0 === a ? "Gr" : 1 === a ? "Bl" : 2 === a ? "Wh" : "") + "]", e ? c + "(" + o.cvt[c] + "," + l + ")" : "", h, "(d =", s, "->", u * i, ")"),
        o.rp1 = o.rp0,
        o.rp2 = h,
        t && (o.rp0 = h)
    }
    ...
    Ft = function(e, t) {
        ...
        i) {
            ...
            for (var l = 0; l < i.length; l++) {
                ...
                O.DEBUG && (console.log("---EXEC COMP " + l + "---"),
                a.step = -1),
                At(c, a, o, s);
            ...
            e.instructions && !a.inhibitGridFit && ((a = new er("glyf",e.instructions)).gZone = a.z0 = a.z1 = a.z2 = n,
            a.contours = r,
            n.push(new Kt(0,0), new Kt(Math.round(e.advanceWidth * o),0)),
            O.DEBUG && (console.log("---EXEC COMPOSITE---"),
            a.step = -1),
            Bt(a),
            n.length -= 2)
        } else
            a = new er("glyf",e.instructions),
            O.DEBUG && (console.log("---EXEC GLYPH---"),
            a.step = -1),
            At(e, a, o, s),
            n = a.gZone;
        return n
    ...
    ,
    At = function(e, t, r, n) {
        for (var a, o, s, i = e.points || [], u = i.length, l = t.gZone = t.z0 = t.z1 = t.z2 = [], p = t.contours = [], c = 0; c < u; c++)
            a = i[c],
        ...
        for (var h = 0; h < u; h++)
            ...
            o || (o = a,
            p.push(h)),
            a.lastPointOfContour ? ((a.nextPointOnContour = o).prevPointOnContour = a,
            o = void 0) : (s = l[h + 1],
        ...
        if (!t.inhibitGridFit) {
            ...
            if (l.push(new Kt(0,0), new Kt(Math.round(e.advanceWidth * r),0)),
            Bt(t),
            l.length -= 2,
            O.DEBUG) {
    ...
    , function(e) {
        e.fv = e.pv,
        O.DEBUG && console.log(e.step, "SFVTPV[]")
    }
    , function(e) {
        var t = e.stack
          , r = t.pop()
    ...
    , function(e) {
        var t = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "SZP0[]", t),
        e.zp0 = t) {
        case 0:
            e.tZone || tr(e),
            e.z0 = e.tZone;
    ...
    , function(e) {
        var t = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "SZP1[]", t),
        e.zp1 = t) {
        case 0:
            e.tZone || tr(e),
            e.z1 = e.tZone;
    ...
    , function(e) {
        var t = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "SZP2[]", t),
        e.zp2 = t) {
        case 0:
            e.tZone || tr(e),
            e.z2 = e.tZone;
    ...
    , function(e) {
        var t = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "SZPS[]", t),
        e.zp0 = e.zp1 = e.zp2 = t,
        t) {
        case 0:
            e.tZone || tr(e),
    ...
    , function(e) {
        O.DEBUG && console.log(e.step, "RTG[]"),
        e.round = zt
    }
    , function(e) {
        O.DEBUG && console.log(e.step, "RTHG[]"),
        e.round = qt
    }
    , function(e) {
        var t = e.stack.pop();
        O.DEBUG && console.log(e.step, "SMD[]", t),
        e.minDis = t / 64
    }
    , function(e) {
        O.DEBUG && console.log(e.step, "ELSE[]"),
        rr(e, !1)
    }
    , function(e) {
        var t = e.stack.pop();
        O.DEBUG && console.log(e.step, "JMPR[]", t),
        e.ip += t - 1
    }
    , function(e) {
        var t = e.stack.pop();
    ...
    , ur, function(e) {
        O.DEBUG && console.log(e.step, "CLEAR[]"),
        e.stack.length = 0
    }
    , function(e) {
        var t = e.stack
          , r = t.pop()
          , n = t.pop();
        O.DEBUG && console.log(e.step, "SWAP[]"),
        t.push(r),
        t.push(n)
    }
    , function(e) {
        var t = e.stack;
        O.DEBUG && console.log(e.step, "DEPTH[]"),
        t.push(t.length)
    }
    , function(e) {
        var t = e.stack
    ...
    , void 0, void 0, void 0, function(e) {
        ...
        for (var s = 0; s < n; s++)
            Bt(e),
            O.DEBUG && console.log(++e.step, s + 1 < n ? "next loopcall" : "done loopcall", s);
        e.ip = a,
        e.prog = o
    }
    , function(e) {
    ...
    , void 0, lr.bind(void 0, 0), lr.bind(void 0, 1), pr.bind(void 0, jt), pr.bind(void 0, Yt), cr.bind(void 0, 0), cr.bind(void 0, 1), hr.bind(void 0, 0), hr.bind(void 0, 1), fr.bind(void 0, 0), fr.bind(void 0, 1), function(e) {
        for (var t = e.stack, r = e.loop, n = e.fv, a = t.pop() / 64, o = e.z2; r--; ) {
            var s = t.pop()
              , i = o[s];
            O.DEBUG && console.log(e.step, (1 < e.loop ? "loop " + (e.loop - r) + ": " : "") + "SHPIX[]", s, a),
            n.setRelative(i, i, a),
            n.touch(i)
        }
        e.loop = 1
    ...
    , function(e) {
        for (var t = e.stack, r = e.rp1, n = e.rp2, a = e.loop, o = e.z0[r], s = e.z1[n], i = e.fv, u = e.dpv, l = e.z2; a--; ) {
            var p = t.pop()
              , c = l[p];
            O.DEBUG && console.log(e.step, (1 < e.loop ? "loop " + (e.loop - a) + ": " : "") + "IP[]", p, r, "<->", n),
    ...
    , dr.bind(void 0, 0), dr.bind(void 0, 1), function(e) {
        for (var t = e.stack, r = e.rp0, n = e.z0[r], a = e.loop, o = e.fv, s = e.pv, i = e.z1; a--; ) {
            var u = t.pop()
              , l = i[u];
            O.DEBUG && console.log(e.step, (1 < e.loop ? "loop " + (e.loop - a) + ": " : "") + "ALIGNRP[]", u),
    ...
    , function(e) {
        O.DEBUG && console.log(e.step, "RTDG[]"),
        e.round = Wt
    }
    ...
    , function(e) {
        ...
        var n = t.pop()
          , a = t.pop();
        O.DEBUG && console.log(e.step, "WS", n, a),
        r[a] = n
    }
    , function(e) {
        var t = e.stack
    ...
    , vr.bind(void 0, 0), vr.bind(void 0, 1), void 0, mr.bind(void 0, 0), mr.bind(void 0, 1), function(e) {
        O.DEBUG && console.log(e.step, "MPPEM[]"),
        e.stack.push(e.ppem)
    }
    , void 0, function(e) {
        O.DEBUG && console.log(e.step, "FLIPON[]"),
        e.autoFlip = !0
    }
    , void 0, void 0, function(e) {
        var t = e.stack
    ...
    , function(e) {
        var t = e.stack
          , r = t.pop();
        O.DEBUG && console.log(e.step, "NOT[]", r),
        t.push(r ? 0 : 1)
    }
    , yr.bind(void 0, 1), function(e) {
        var t = e.stack.pop();
        O.DEBUG && console.log(e.step, "SDB[]", t),
        e.deltaBase = t
    }
    , function(e) {
        var t = e.stack.pop();
    ...
    , function(e) {
        var t = e.stack
          , r = t.pop()
          , n = t.pop();
        O.DEBUG && console.log(e.step, "ADD[]", r, n),
        t.push(n + r)
    }
    , function(e) {
        var t = e.stack
          , r = t.pop()
          , n = t.pop();
        O.DEBUG && console.log(e.step, "SUB[]", r, n),
        t.push(n - r)
    }
    , function(e) {
        var t = e.stack
    ...
    , function(e) {
        var t = e.stack
          , r = t.pop();
        O.DEBUG && console.log(e.step, "ABS[]", r),
        t.push(Math.abs(r))
    }
    , function(e) {
        var t = e.stack
          , r = t.pop();
        O.DEBUG && console.log(e.step, "NEG[]", r),
        t.push(-r)
    }
    , function(e) {
        var t = e.stack
    ...
    , yr.bind(void 0, 2), yr.bind(void 0, 3), Sr.bind(void 0, 1), Sr.bind(void 0, 2), Sr.bind(void 0, 3), function(e) {
        var t, r = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "SROUND[]", r),
        e.round = Vt,
        192 & r) {
        case 0:
            t = .5;
    ...
    , function(e) {
        var t, r = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "S45ROUND[]", r),
        e.round = Vt,
        192 & r) {
        case 0:
            t = Math.sqrt(2) / 2;
    ...
    , void 0, void 0, function(e) {
        O.DEBUG && console.log(e.step, "ROFF[]"),
        e.round = Ht
    }
    , void 0, function(e) {
        O.DEBUG && console.log(e.step, "RUTG[]"),
        e.round = _t
    }
    , function(e) {
        O.DEBUG && console.log(e.step, "RDTG[]"),
        e.round = Xt
    }
    ...
    , function(e) {
        var t = e.stack.pop()
          , r = e.stack.pop();
        switch (O.DEBUG && console.log(e.step, "INSTCTRL[]", t, r),
        t) {
        case 1:
    ...
    , void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, Tr.bind(void 0, 1), Tr.bind(void 0, 2), Tr.bind(void 0, 3), Tr.bind(void 0, 4), Tr.bind(void 0, 5), Tr.bind(void 0, 6), Tr.bind(void 0, 7), Tr.bind(void 0, 8), kr.bind(void 0, 1), kr.bind(void 0, 2), kr.bind(void 0, 3), kr.bind(void 0, 4), kr.bind(void 0, 5), kr.bind(void 0, 6), kr.bind(void 0, 7), kr.bind(void 0, 8), Ur.bind(void 0, 0, 0, 0, 0, 0), Ur.bind(void 0, 0, 0, 0, 0, 1), Ur.bind(void 0, 0, 0, 0, 0, 2), Ur.bind(void 0, 0, 0, 0, 0, 3), Ur.bind(void 0, 0, 0, 0, 1, 0), Ur.bind(void 0, 0, 0, 0, 1, 1), Ur.bind(void 0, 0, 0, 0, 1, 2), Ur.bind(void 0, 0, 0, 0, 1, 3), Ur.bind(void 0, 0, 0, 1, 0, 0), Ur.bind(void 0, 0, 0, 1, 0, 1), Ur.bind(void 0, 0, 0, 1, 0, 2), Ur.bind(void 0, 0, 0, 1, 0, 3), Ur.bind(void 0, 0, 0, 1, 1, 0), Ur.bind(void 0, 0, 0, 1, 1, 1), Ur.bind(void 0, 0, 0, 1, 1, 2), Ur.bind(void 0, 0, 0, 1, 1, 3), Ur.bind(void 0, 0, 1, 0, 0, 0), Ur.bind(void 0, 0, 1, 0, 0, 1), Ur.bind(void 0, 0, 1, 0, 0, 2), Ur.bind(void 0, 0, 1, 0, 0, 3), Ur.bind(void 0, 0, 1, 0, 1, 0), Ur.bind(void 0, 0, 1, 0, 1, 1), Ur.bind(void 0, 0, 1, 0, 1, 2), Ur.bind(void 0, 0, 1, 0, 1, 3), Ur.bind(void 0, 0, 1, 1, 0, 0), Ur.bind(void 0, 0, 1, 1, 0, 1), Ur.bind(void 0, 0, 1, 1, 0, 2), Ur.bind(void 0, 0, 1, 1, 0, 3), Ur.bind(void 0, 0, 1, 1, 1, 0), Ur.bind(void 0, 0, 1, 1, 1, 1), Ur.bind(void 0, 0, 1, 1, 1, 2), Ur.bind(void 0, 0, 1, 1, 1, 3), Ur.bind(void 0, 1, 0, 0, 0, 0), Ur.bind(void 0, 1, 0, 0, 0, 1), Ur.bind(void 0, 1, 0, 0, 0, 2), Ur.bind(void 0, 1, 0, 0, 0, 3), Ur.bind(void 0, 1, 0, 0, 1, 0), Ur.bind(void 0, 1, 0, 0, 1, 1), Ur.bind(void 0, 1, 0, 0, 1, 2), Ur.bind(void 0, 1, 0, 0, 1, 3), Ur.bind(void 0, 1, 0, 1, 0, 0), Ur.bind(void 0, 1, 0, 1, 0, 1), Ur.bind(void 0, 1, 0, 1, 0, 2), Ur.bind(void 0, 1, 0, 1, 0, 3), Ur.bind(void 0, 1, 0, 1, 1, 0), Ur.bind(void 0, 1, 0, 1, 1, 1), Ur.bind(void 0, 1, 0, 1, 1, 2), Ur.bind(void 0, 1, 0, 1, 1, 3), Ur.bind(void 0, 1, 1, 0, 0, 0), Ur.bind(void 0, 1, 1, 0, 0, 1), Ur.bind(void 0, 1, 1, 0, 0, 2), Ur.bind(void 0, 1, 1, 0, 0, 3), Ur.bind(void 0, 1, 1, 0, 1, 0), Ur.bind(void 0, 1, 1, 0, 1, 1), Ur.bind(void 0, 1, 1, 0, 1, 2), Ur.bind(void 0, 1, 1, 0, 1, 3), Ur.bind(void 0, 1, 1, 1, 0, 0), Ur.bind(void 0, 1, 1, 1, 0, 1), Ur.bind(void 0, 1, 1, 1, 0, 2), Ur.bind(void 0, 1, 1, 1, 0, 3), Ur.bind(void 0, 1, 1, 1, 1, 0), Ur.bind(void 0, 1, 1, 1, 1, 1), Ur.bind(void 0, 1, 1, 1, 1, 2), Ur.bind(void 0, 1, 1, 1, 1, 3)],
    ...
    wr.prototype.runContextCheck = function(o) {
        ...
        this.contextCheckers.forEach(function(e) {
            ...
            if (!r && e.checkStart(o) && (r = new Er(i,null,t),
            ...
            return function(e) {
                return function(e, t) {
                    ...
                    var l = new Lr(u,0)
                      ...
                      , c = [];
                    if (n.length === t.inputCoverage.length && i.length === t.lookaheadCoverage.length && p.length === t.backtrackCoverage.length)
    ...
    Br.prototype.lookupFeature = function(e) {
        ...
        for (var a = this.getFeatureLookups(n), o = [].concat(t.context), s = 0; s < a.length; s++)
            for (var i = a[s], u = this.getLookupSubtables(i), l = 0; l < u.length; l++) {
                var p = u[l]
                ...
                case "63":
                    f = h(t),
                    Array.isArray(f) && f.length && o.splice(r, 1, new Fr({
                        id: 63,
                        tag: e.tag,
                        substitution: f
                    }));
                ...
                if (!Mr(e.char)) {
                    ...
                    if (-1 !== s.indexOf(r)) {
                        ...
                        if (a instanceof Error)
                            return console.info(a.message);
                        a.forEach(function(e, t) {
                            e instanceof Fr && (Wr(e, i, t),
                            u.context[t] = e.substitution)
                        })
                    }
                }
            })
    ...
    function Qr() {
        var t = this;
        this.featuresTags.hasOwnProperty("arab") && -1 !== this.featuresTags.arab.indexOf("rlig") && (Zr.call(this),
    ...
    function Kr() {
        var t = this;
        this.featuresTags.hasOwnProperty("latn") && -1 !== this.featuresTags.latn.indexOf("liga") && (Zr.call(this),
    ...
    function Jr(e) {
        (e = e || {}).tables = e.tables || {},
        e.empty || (Lt(e.familyName, "When creating a new Font object, familyName is required."),
        Lt(e.styleName, "When creating a new Font object, styleName is required."),
        Lt(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."),
        Lt(e.ascender, "When creating a new Font object, ascender is required."),
        Lt(e.descender <= 0, "When creating a new Font object, negative descender value is required."),
        this.names = {
            fontFamily: {
                en: e.familyName || " "
            },
    ...
    Yr.prototype.applyFeaturesToContexts = function() {
        this.checkContextReady("arabicWord") && (function() {
            var t = this;
            this.featuresTags.hasOwnProperty("arab") && (Zr.call(this),
            this.tokenizer.getContextRanges("arabicWord").forEach(function(e) {
                qr.call(t, e)
            }))
        }
        ...
        this.checkContextReady("arabicSentence") && function() {
            var r = this;
    ...
    Jr.prototype.stringToGlyphs = function(e, t) {
        ...
        for (var o = n.getTextGlyphs(e), s = o.length, i = new Array(s), u = this.glyphs.get(0), l = 0; l < s; l += 1)
    ...
    Jr.prototype.forEachGlyph = function(e, t, r, n, a, o) {
        ...
        for (var p = 0; p < u.length; p += 1) {
            ...
            a.kerning && p < u.length - 1)
                t += (s ? this.position.getKerningValue(s, c.index, u[p + 1].index) : this.getKerningValue(c, u[p + 1])) * i;
    ...
    function nn() {
        var e = this.parseUShort();
        return w.argument(1 === e || 2 === e || 3 === e, "Unsupported CaretValue table version."),
        1 === e ? {
    ...
    function sn() {
        ...
        this.parseList(oe.pointer(oe.coverage))
    }
    var un = {
        make: function(e, t) {
            var r, n, a, o, s = new $.Table("fvar",[{
                name: "version",
                type: "ULONG",
                value: 65536
            }, {
        ...
        parse: function(e, t, r) {
            ...
            n.skip("uShort", 1);
            for (var s, i, u, l, p, c = n.parseUShort(), h = n.parseUShort(), f = n.parseUShort(), d = n.parseUShort(), g = [], v = 0; v < c; v++)
                g.push((s = e,
                i = t + o + v * h,
                u = r,
                p = l = void 0,
    ...
    var ln = {
        parse: function(e, t) {
            ...
            return 1.2 <= n && (a.markGlyphSets = r.parsePointer(sn)),
            a
        }
    }
      , pn = new Array(10);
    ...
    var hn = {
        parse: function(e, t) {
            var r = new oe(e,t = t || 0)
              , n = r.parseVersion(1);
            return w.argument(1 === n || 1.1 === n, "Unsupported GPOS table version " + n),
            1 === n ? {
                version: n,
                scripts: r.parseScriptList(),
                features: r.parseFeatureList(),
    ...
    function bn(e, t) {
        var r, n;
        t = null == t ? {} : t;
        var a, o, s, i, u, l, p, c, h, f, d, g, v, m = new Jr({
            empty: !0
        }), y = new DataView(e,0), b = [], S = ie.getTag(y, 0);
        ...
        for (var T = 0; T < a; T += 1) {
            ...
            case "OS/2":
                U = yn(y, k),
                m.tables.os2 = st.parse(U.data, U.offset);
                break;
            case "post":
                U = yn(y, k),
        ...
        var O = yn(y, d);
        if (m.tables.name = at.parse(O.data, O.offset, n),
        ...
        var D = yn(y, c);
        if (qe.parse(m, D.data, D.offset, m.numberOfHMetrics, m.numGlyphs, m.glyphs, t),
        me(m, t),
        h) {
            var I = yn(y, h);
        ...
        if (l) {
            var G = yn(y, l);
            m.tables.gpos = hn.parse(G.data, G.offset),
            m.position.init()
        }
        if (p) {
            var B = yn(y, p);
