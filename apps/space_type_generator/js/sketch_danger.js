...
function preload(){
  font0 = loadFont('./font/IBMPlexMono-Regular.otf');

  font1 = loadFont('./font/IBMPlexMono-Regular.otf');
  font2 = loadFont('./font/IBMPlexMono-Regular.otf');
  font3 = loadFont('./font/IBMPlexMono-Regular.otf');
  font4 = loadFont('./font/IBMPlexMono-Regular.otf');
  font5 = loadFont('./font/IBMPlexMono-Regular.otf');
}
...
function setup() {
  ...
  noiseSpeedSlider = createSlider(1,50,20, 0.01); noiseSpeedSlider.position(10,40); noiseSpeedSlider.style('width','300px');
...
function editorViewDraw(){
  ...
  if(invertCheck.checked()){
    foreCol = color('#dd1717ff');
    bkgdCol = color('#1552d6ff');
  } else {
