...
var EPHEMERAL_ALPHA = 1; // 0-255. lower = longer lasting persistence
var FPS = 20;
var SCENE_SCALE = 1;
...
var PALETTES = [
//   ["Autumn Rhythm", '#d3b893', [
//     '#e3ded640', '#100d0340', '#99846040', '#99846040', '#4a4b5440', '#85756640', '#21211d40',
//     '#e3ded640', '#100d0340', '#99846040', '#99846040', '#4a4b5440', '#85756640', '#21211d40',
//     '#e3ded640', '#100d0340', '#99846040', '#99846040', '#4a4b5440', '#85756640', '#21211d40',
//     '#e3ded640', '#100d0340', '#99846040', '#99846040', '#4a4b5440', '#85756640', '#21211d40',
//     '#e3ded640', '#100d0340', '#99846040'
//     ]],
//   ["Number 1", '#e4caa805', [
//     '#d2aa3440', '#30393d40', '#ffffff40', '#428e9440', '#f7ccc840', '#5c1a1440', '#10624440',
//     '#d2aa3440', '#30393d40', '#fff1d540', '#428e9440', '#f7ccc840', '#5c1a1440', '#10624440',
//     '#d2aa3440', '#30393d40', '#fff1d540', '#428e9440', '#f7ccc840', '#5c1a1440', '#10624440',
//     '#d2aa3440', '#30393d40', '#fff1d540', '#428e9440', '#f7ccc840', '#5c1a1440', '#10624440',
//     '#d2aa3440', '#30393d40', '#fff1d540', '#428e9440', 
// ]],
...
//   ["Reversion", '#cdd2d601', ['#00149140', '#efbb0d40', '#03010240', '#5e8aaf40', '#9c53bf20', '#b1262340', '#098d5e40']],
...
sketch = function(p) {
  ...
  p.setup = function()
  {
    ...
    if(!hideCanvasUI){
        FPSslider = p.createSlider(1, 60, 20); FPSslider.position(25, 20); FPSslider.style('width', '100px'); FPSslider.attribute('title', 'FPS')
        ephemeralCheckBox = p.createCheckbox('', true);ephemeralCheckBox.position(50, 72); ephemeralCheckBox.attribute('title', 'Ephemeral')
        ephemeralAlphaSlider = p.createSlider(0, 255, 10);ephemeralAlphaSlider.position(20,40); ephemeralAlphaSlider.attribute('title', 'EPHEMERAL_ALPHA')
        ...
        bkgdColorPicker = p.createColorPicker('#fff');bkgdColorPicker.position(152, 295);bkgdColorPicker.style('height', '50px');
    }
  }

    function newPaintLines(){
        PAINTLINES = [];
